...
With all this in mind, I've been thinking lately about how scale can operate as a useful constraint when brainstorming new ways to teach DH. I'm calling the exercise "telescoping digital pedagogy." To practice it, you take a single idea and think through the different sizes and shapes that teaching might take. You'll necessarily need to operate at different levels of completeness—it takes far more work to float a syllabus as opposed to a workshop. But working through the thought exercise can push your teaching in different, unexpected directions. To practice telescoping your digital pedagogy, you imagine an idea taught in the smallest way possible. Then you scale it up to be as big as you can imagine. 
...
4. Design a course description and six selected readings on a topic (meant to stand in for a whole syllabus)
5. Build out a certificate, minor, or major based around the course.  

As an example, here's my attempt to run the idea of digital pedagogy through the telescope:

Digital Pedagogy

* **Sentence**
  * "Digital pedagogy considers the many points of intersection between teaching and technology, how teachers can effectively new tools and methods in the classroom as well as how the very nature of education has fundamentally been changed by them."
* **Classroom activity** 
  * This ninety-minute activity asks students to explore their own relationship to technology as teachers and learners. It involves three phases: reflection, planning, discussion. 
    * In the first phase, participants will reflect on their most significant learning experience involving technology. What comes to mind? What about it was effective or traumatic for you? Summarize it in one sentence. Distill it down to a principle.
...
* **Final project**
  * For a final project in a course on digital pedagogy, I would have students develop a "pedagogical scrapbook." This document collects various teaching materials—lesson plans, course descriptions, workshop activities—in a way that students can pull from in different professional contexts. But I would frame it as a scrapbook so as to encourage personal reflections, meaningful connections, and narrative approaches to the material as well. 
* **Course description**
...
* **Curriculum**
  ...
  * Practicum course (3 credits) during which students teach in-house workshops as a part of our DH center on topics of their choosing.
...
How often do we teach to the moment, putting together only what seems like it will work to get by? Considering a range of options for any teachable topic is a luxury most of us don't have. The telescoping digital pedagogy activity invites you to sit with a single idea such that you let it unfold in as many different ways as possible. Each of these different constraints requires you to think in different ways about the same set of ideas. 