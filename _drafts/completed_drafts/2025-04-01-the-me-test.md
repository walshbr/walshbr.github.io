...
![MATERIALS  - Appropriate, accessible. EVIDENCE - Identifiable, measurable](/assets/post-media/book-number-graph/6.jpeg)
...
![Prompt: I am interested in which Shakespeare character is the most important in Romeo and Juliet.](/assets/post-media/book-number-graph/8.jpeg)

![Prompt: I am interested in how space and place are represented in literature of the southeastern United States.](/assets/post-media/book-number-graph/9.jpeg)
...
USLDH has shared the [recording link](INSERT LINK HERE), so feel free to check out the recording if you want to see the activities in action. The slides can be found [here](https://bit.ly/book-number-graph). And never forget the most important thing to ask yourself the next time you're working on a text analysis problem:
