...
* "[A Humanists Cookbook for Natural Language Processing in Python](A Humanist's Cookbook for Natural Language Processing in Python](https://github.com/walshbr/humanists-nlp-cookbook/blob/release/toc.ipynb)", with Rebecca Draughon, Fall 2020.
